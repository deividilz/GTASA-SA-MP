...
public OnPlayerCommandText(playerid, cmdtext[]) {
        ...
        if (!strcmp("/laseron", cmdtext, true)) {
                ...
                SendClientMessage(playerid, 0x00E800FF, "Laser ativado!");
                return 1;
        }
        ...
        if (!strcmp("/laseroff", cmdtext, true)) {
                SetPVarInt(playerid, "laser", 0);
                RemovePlayerAttachedObject(playerid, 0);
                SendClientMessage(playerid, 0x00E800FF, "Laser desativado!");
                return 1;
        }
        ...
        if (!strcmp("/lasercor", cmd, true)) {
                ...
                if (!strlen(tmp)) {
                        SendClientMessage(playerid, 0x00E800FF, "Uso: /lasercor [cor]");
                        SendClientMessage(playerid, 0x00E800FF, "{FFFFFF}Cores: {6200FF}Azul, {FF2EC8}Rosa, {FFA53D}Laranja, {1FFF31}Verde, {F4FF1F}Amarelo");
                        return 1;
                }
                ...
                else SendClientMessage(playerid, 0xFF0000FF, "Cor incorreta!");
                return 1;
        }
