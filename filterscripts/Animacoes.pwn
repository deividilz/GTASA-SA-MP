...
new ASTR[40] = "[ERRO]: Você não pode usar anim's agora";
...
public OnFilterScriptInit()
{
        ...
        "~b~~k~~PED_LOCK_TARGET~ ~w~p/ parar anim");
...
stock AllowAnn(playerid)
{
if(CallRemoteFunction("GetPlayerArenaStatus","i",playerid) != 0) return 0;
if(CallRemoteFunction("GetPlayerArenaStatus2","i",playerid) != 0) return 0;
...
public OnPlayerCommandText(playerid, cmdtext[])
{
 ...
 if(!AllowAnn(playerid)) return SendClientMessage(playerid,0xFF0000FF,ASTR);
 StopLoopingAnim(playerid);
 return 1;
 }
        ...
        if(strcmp(cmd,"/animlist",true)==0)
        {
            SendClientMessage(playerid, YELLOW, "________________________________________________________________________________________________________________________");
                SendClientMessage(playerid,RED,"-Anims Disponiveis:");
            SendClientMessage(playerid,WHITE,"/fall - /fallback - /injured - /cakick - /push - /lowbodypush - /handsup - /bomb - /drunk - /getarrested - /laugh - /sup");
        ...
        SendClientMessage(playerid,WHITE,"/pee - /lean - /run /stop /punheta /mulhersexo /comermulher /de4 /mulherfodida");
    ...
    return 1;
       ...
       StopLoopingAnim(playerid);
       ClearAnimations(playerid);
	   ApplyAnimation(playerid,"benchpress","gym_bp_up_B",4.1,0,1,1,1,1); return 1;}
    ...
    if(!AllowAnn(playerid)) return SendClientMessage(playerid,0xFF0000FF,ASTR);
            ...
            StopLoopingAnim(playerid);
            ClearAnimations(playerid);
	        ApplyAnimation(playerid,"MD_END","END_SC1_SMO",4.1,0,1,1,1,1); return 1;}
    ...
    if(!AllowAnn(playerid)) return SendClientMessage(playerid,0xFF0000FF,ASTR);
            ...
            StopLoopingAnim(playerid);
            ClearAnimations(playerid);
         	ApplyAnimation(playerid,"FINALE","FIN_Land_Car",4.1,0,1,1,1,1); return 1;}

	if (strcmp("/mulherfodida", cmdtext, true, 10) ==0){
	if(!AllowAnn(playerid)) return SendClientMessage(playerid,0xFF0000FF,ASTR);
            ClearAnimations(playerid);
            StopLoopingAnim(playerid);
            ClearAnimations(playerid);
        	ApplyAnimation(playerid,"FINALE","FIN_Land_Die",4.1,0,1,1,1,1); return 1;}
        	
   	if (strcmp("/animoff", cmdtext, true, 10) ==0){
   	if(!AllowAnn(playerid)) return SendClientMessage(playerid,0xFF0000FF,ASTR);
            ClearAnimations(playerid);
            StopLoopingAnim(playerid);
            ClearAnimations(playerid);
    ...
    {
    if(!AllowAnn(playerid)) return SendClientMessage(playerid,0xFF0000FF,ASTR);
        if (!strlen(cmdtext[7])) return SendClientMessage(playerid,0xEFEFF7AA,"[USO]: /smoke [1-4]");
        switch (cmdtext[7])
        {
                ...
                default: SendClientMessage(playerid,0xEFEFF7AA,"[USO]: /smoke [1-4]");
        }
        return 1;
    }
        // Sit
    ...
    {
    if(!AllowAnn(playerid)) return SendClientMessage(playerid,0xFF0000FF,ASTR);
        if (!strlen(cmdtext[5])) return SendClientMessage(playerid,0xEFEFF7AA,"[USO]: /sup [1-3]");
        switch (cmdtext[5])
        {
                ...
                default: SendClientMessage(playerid,0xEFEFF7AA,"[USO]: /sup [1-3]");
        }
        return 1;
    }
    ...
    {
    if(!AllowAnn(playerid)) return SendClientMessage(playerid,0xFF0000FF,ASTR);
        if (!strlen(cmdtext[5])) return SendClientMessage(playerid,0xEFEFF7AA,"[USO]: /rap [1-4]");
        switch (cmdtext[5])
        {
            case '1': LoopingAnim(playerid,"RAPPING","RAP_A_Loop",4.0,1,0,0,0,0);
                ...
                default: SendClientMessage(playerid,0xEFEFF7AA,"[USO]: /rap [1-4]");
        }
        return 1;
    }
    ...
    {
    if(!AllowAnn(playerid)) return SendClientMessage(playerid,0xFF0000FF,ASTR);
        if (!strlen(cmdtext[7])) return SendClientMessage(playerid,0xEFEFF7AA,"[USO]: /knife [1-4]");
        switch (cmdtext[7])
        {
            case '1': LoopingAnim(playerid,"KNIFE","KILL_Knife_Ped_Damage",4.0,0,1,1,1,0);
                ...
                default: SendClientMessage(playerid,0xEFEFF7AA,"[USO]: /knife [1-4]");
        }
        return 1;
    }
    ...
    {
    if(!AllowAnn(playerid)) return SendClientMessage(playerid,0xFF0000FF,ASTR);
        if (!strlen(cmdtext[8])) return SendClientMessage(playerid,0xEFEFF7AA,"[USO]: /basket [1-6]");
        switch (cmdtext[8])
        {
                ...
                default: SendClientMessage(playerid,0xEFEFF7AA,"[USO]: /basket [1-6]");
        }
        return 1;
    }
    ...
    {
    if(!AllowAnn(playerid)) return SendClientMessage(playerid,0xFF0000FF,ASTR);
        if (!strlen(cmdtext[8])) return SendClientMessage(playerid,0xEFEFF7AA,"[USO]: /reload [deagle/smg/ak/m4]");
        ...
        else SendClientMessage(playerid,0xEFEFF7AA,"[USO]: /reload [deagle/smg/ak/m4]");
        return 1;
    }
    ...
    {
    if(!AllowAnn(playerid)) return SendClientMessage(playerid,0xFF0000FF,ASTR);
        if (!strlen(cmdtext[6])) return SendClientMessage(playerid,0xEFEFF7AA,"[USO]: /gwalk [1/2]");
        ...
        else SendClientMessage(playerid,0xEFEFF7AA,"[USO]: /gwalk [1/2]");
        return 1;
    }
    ...
    {
    if(!AllowAnn(playerid)) return SendClientMessage(playerid,0xFF0000FF,ASTR);
        if (!strlen(cmdtext[5])) return SendClientMessage(playerid,0xEFEFF7AA,"[USO]: /aim [1-.]");
        switch (cmdtext[5])
        {
                ...
                default: SendClientMessage(playerid,0xEFEFF7AA,"[USO]: /aim [1-3]");
        }
        return 1;
    }
    ...
    {
    if(!AllowAnn(playerid)) return SendClientMessage(playerid,0xFF0000FF,ASTR);
        if (!strlen(cmdtext[6])) return SendClientMessage(playerid,0xEFEFF7AA,"[USO]: /lean [1-2]");
        switch (cmdtext[6])
        {
                case '1': LoopingAnim(playerid,"GANGS","leanIDLE",4.0,0,1,1,1,0);
                case '2': LoopingAnim(playerid,"MISC","Plyrlean_loop",4.0,0,1,1,1,0);
                default: SendClientMessage(playerid,0xEFEFF7AA,"[USO]: /lean [1-2]");
        }
        return 1;
    }
    ...
    {
    if(!AllowAnn(playerid)) return SendClientMessage(playerid,0xFF0000FF,ASTR);
        if (!strlen(cmdtext[7])) return SendClientMessage(playerid,0xEFEFF7AA,"[USO]: /strip [A-G]");
        switch (cmdtext[7])
        {
                ...
                default: SendClientMessage(playerid,0xEFEFF7AA,"[USO]: /strip [A-G]");
        }
        return 1;
    }
    ...
    if(strcmp(cmd, "/inbedleft", true) == 0) {
        ...
        if(!AllowAnn(playerid)) return SendClientMessage(playerid,0xFF0000FF,ASTR);
                ...
                tmp = strtok(cmdtext, idx);
                        if(!strlen(tmp)) {
                                SendClientMessage(playerid,0xFF0000FF,"[USO]: /dance [style 1-4]");
                                return 1;
                        }
