...
#define COLOUR_CHATPROX 0x8983B8FF
...
/*
1 - Text do GPS em baixo do Radar (Maior)
2 - Text do GPS em cima dos ícones de Weapon, Health, Armour e Money (Maior)
3 - Text do GPS em cima dos ícones de Weapon, Health, Armour e Money (Menor)
4 - Text do GPS em baixo dos ícones de Weapon, Health, Armour e Money (Menor)
*/

// Striker Samp - Tudo Para Seu Servidor SA-MP
// www.strikersamp.blogspot.com

#define UsarGpsText 4
...
if(!IsPlayerConnected(playerid) || !IsPlayerConnected(Gplayerid))
{
return -1.00;
}
...
stock Float:atan3(Float:y, Float:x)
{
x = atan2(y, x) - 90;
...
stock Float:Angle2D(Float:x1, Float:y1, Float:x2, Float:y2)
{
x2 -= x1;
y2 -= y1;
return atan3(y2, x2);
...
new GPS_Update_Timer[MAX_PLAYERS],COLOR_Update_Timer[MAX_PLAYERS],bool:GPS_Ativo[MAX_PLAYERS];
...
AGps[playerid] = true;
SendClientMessage(playerid, COLOUR_INFORMACAO, "[INFO]: Você está com Anti-GPS, isso custou $15000");}else{
...
{
if(Piscando[playerid] == false) { SetPlayerMarkerForPlayer(playerid, rastreado, Vermelho); Piscando[playerid] = true; }
else { SetPlayerMarkerForPlayer(playerid, rastreado, VerdeClaro); Piscando[playerid] = false; }
}
return 1;}
...
{
for(new i; i < GetMaxPlayers(); i++){PararGPS(i);}
...
{
#if UsarGpsText == 1
TextGPS1[i] = TextDrawCreate(2.000000,424.000000,"~b~~h~~h~Nick~w~: ~b~~h~~h~+++ ~w~- ~y~ID~w~: ~y~+++ ~w~- ~p~~h~Distancia~w~: ~p~~h~+++ metro(s).");
TextGPS2[i] = TextDrawCreate(2.000000,438.000000,"~g~~h~~h~Cidade~w~: ~g~~h~~h~+++ ~w~- ~r~~h~Local~w~: ~r~~h~+++.");
TextDrawTextSize(TextGPS1[i],363.000000,-1.000000);
TextDrawTextSize(TextGPS2[i],363.000000,0.000000);
TextDrawLetterSize(TextGPS1[i],0.299999,1.000000);
TextDrawLetterSize(TextGPS2[i],0.299999,1.000000);

#elseif UsarGpsText == 2
TextGPS1[i] = TextDrawCreate(274.000000,2.000000,"~b~~h~~h~Nick~w~: ~b~~h~~h~+++ ~w~- ~y~ID~w~: ~y~+++ ~w~- ~p~~h~Distancia~w~: ~p~~h~+++ metro(s).");
TextGPS2[i] = TextDrawCreate(274.000000,15.000000,"~g~~h~~h~Cidade~w~: ~g~~h~~h~+++ ~w~- ~r~~h~Local~w~: ~r~~h~+++.");
TextDrawTextSize(TextGPS1[i],636.000000,-1.000000);
TextDrawTextSize(TextGPS2[i],636.000000,0.000000);
TextDrawLetterSize(TextGPS1[i],0.299999,1.000000);
TextDrawLetterSize(TextGPS2[i],0.299999,1.000000);

#elseif UsarGpsText == 3
TextGPS1[i] = TextDrawCreate(394.000000,2.000000,"~b~~h~~h~Nick~w~: ~b~~h~~h~+++ ~w~- ~y~ID~w~: ~y~+++ ~w~- ~p~~h~Distancia~w~: ~p~~h~+++ metro(s).");
TextGPS2[i] = TextDrawCreate(394.000000,15.000000,"~g~~h~~h~Cidade~w~: ~g~~h~~h~+++ ~w~- ~r~~h~Local~w~: ~r~~h~+++.");
TextDrawTextSize(TextGPS1[i],637.000000,0.000000);
TextDrawTextSize(TextGPS2[i],637.000000,-111.000000);
TextDrawLetterSize(TextGPS1[i],0.199999,0.899999);
TextDrawLetterSize(TextGPS2[i],0.199999,1.000000);

#elseif UsarGpsText == 4
TextGPS1[i] = TextDrawCreate(398.000000,101.000000,"~b~~h~~h~Nick~w~: ~b~~h~~h~+++ ~w~- ~y~ID~w~: ~y~+++ ~w~- ~p~~h~Distancia~w~: ~p~~h~+++ metro(s).");
TextGPS2[i] = TextDrawCreate(398.000000,114.000000,"~g~~h~~h~Cidade~w~: ~g~~h~~h~+++ ~w~- ~r~~h~Local~w~: ~r~~h~+++.");
TextDrawTextSize(TextGPS1[i],637.000000,0.000000);
TextDrawTextSize(TextGPS2[i],637.000000,0.000000);
TextDrawLetterSize(TextGPS1[i],0.199999,0.899999);
TextDrawLetterSize(TextGPS2[i],0.199999,0.899999);
#endif

TextDrawUseBox(TextGPS1[i],1);
TextDrawBoxColor(TextGPS1[i],0x00000066);
TextDrawUseBox(TextGPS2[i],1);
TextDrawBoxColor(TextGPS2[i],0x00000066);
TextDrawAlignment(TextGPS1[i],0);
TextDrawAlignment(TextGPS2[i],0);
TextDrawBackgroundColor(TextGPS1[i],0x000000ff);
TextDrawBackgroundColor(TextGPS2[i],0x000000ff);
TextDrawFont(TextGPS1[i],1);
TextDrawFont(TextGPS2[i],1);
TextDrawColor(TextGPS1[i],0xffffffff);
TextDrawColor(TextGPS2[i],0xffffffff);
TextDrawSetOutline(TextGPS1[i],1);
TextDrawSetOutline(TextGPS2[i],1);
TextDrawSetProportional(TextGPS1[i],1);
TextDrawSetProportional(TextGPS2[i],1);
TextDrawSetShadow(TextGPS1[i],1);
TextDrawSetShadow(TextGPS2[i],1);
}
return 1;
}
